-- ============================================
-- COMPLETE FIX FOR POWERXCHANGE NOTIFICATIONS & ORDERS
-- Run this ONE script in Supabase SQL Editor
-- This will fix all RLS issues and enable the notification system
-- ============================================
...
-- 3. Run the script
-- 4. The alert should no longer appear
-- 5. Test the system with two user accounts
-- ============================================